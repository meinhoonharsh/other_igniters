    ...
    <div style="background:var(--darkestShade); color:#fffa; padding: 50px 0;">
        ...
        <div class="container py-5">
                    ...
                    <a class="my-4" href="{{ route('blog', ['slug' => $blog->slug]) }}"
                        ...
                        <div class="col-12 mx-auto row" style="border:3px solid #fff7;">
                            <div class="col-md-5 p-0">
                                <img class="w-100" src="/public/uploads/ft_img/{{ $blog->image }}" alt="Card image cap"
            ...
            <ul class="pagination justify-content-center mt-5 pagination-lg">
                <li class="page-item 
  @if ($prev == 0) disabled @endif
  "><a class="page-link"
                        href="{{ route('blogs', ['id' => $id - 1]) }}">Previous</a></li>
                <li class="page-item
  
  @if ($next == 0) disabled @endif
  "><a class="page-link"
                        href="{{ route('blogs', ['id' => $id + 1]) }}">Next</a></li>
            </ul>
